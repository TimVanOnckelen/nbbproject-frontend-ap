 ...
 * 
 * @export
 * @interface ExerciseDates
 */
export interface ExerciseDates {
    /**
     * 
     * @type {string}
     * @memberof ExerciseDates
     */
...
export const TokenApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiTokenPost: async (userLogin?: UserLogin, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
...
export class TokenApi extends BaseAPI {
     ...
     * @memberof TokenApi
     */
    public apiTokenPost(userLogin?: UserLogin, options?: AxiosRequestConfig) {
        return TokenApiFp(this.configuration).apiTokenPost(userLogin, options).then((request) => request(this.axios, this.basePath));
    }
}
